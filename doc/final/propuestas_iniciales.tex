...
% excluyente)
%
% Este parrafo es el fundamental y debe ser redactado cuidadosamente 
% se\~nalando las caracteristicas esenciales de un desarrollo autosustentable,
% el valor agregado es el beneficio social y principalmente este enfoque no
% trabaja sobre un mecanismo de competencia sino de cooperatividad, que le da
% la sustentabilidad suficiente para evolucionar.
