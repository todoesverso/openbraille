...
El endpoint 0 debe existir en todos los dispositivos, ya que cumple la
funci\'on espec\'ifica de realizar el \emph{handshaking} y todo el control en
una comunicaci\'on USB. 
...
pedazos de datos. \'Este tipo de transferencias provee correcci\'on de datos
...
\emph{BDnSTAT} se encuentra siempre a 4n-1 bytes de distancia de la
direcci\'on 400h.\\
